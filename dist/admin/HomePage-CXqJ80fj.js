...
const HomePage = () => {
  ...
  const copyLabel = react.useCallback(
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(CustomGridItem, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingLeft: 4, children: [
      ...
      !loading && !result && /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.Flex,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral500", children: formatMessage(t("placeholder", "Metadata will appear here.")) })
        }
      ),
      result && !loading && /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(PremiumCard, { background: "neutral0", padding: 5, hasRadius: true, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(MetaLabel, { variant: "pi", fontWeight: "bold", children: formatMessage(t("meta-title", "Meta Title")) }),
            /* @__PURE__ */ jsxRuntime.jsx(CopyButton, { onClick: () => handleCopy(result.title, "title"), children: copyLabel("title") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "epsilon", style: { lineHeight: "1.5" }, children: result.title || noData })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(PremiumCard, { background: "neutral0", padding: 5, hasRadius: true, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(MetaLabel, { variant: "pi", fontWeight: "bold", children: formatMessage(t("meta-description", "Meta Description")) }),
            /* @__PURE__ */ jsxRuntime.jsx(CopyButton, { onClick: () => handleCopy(result.description, "description"), children: copyLabel("description") })
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "epsilon", style: { lineHeight: "1.5" }, children: result.description || noData })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(PremiumCard, { background: "neutral0", padding: 5, hasRadius: true, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(MetaLabel, { variant: "pi", fontWeight: "bold", children: formatMessage(t("keywords", "Keywords")) }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "epsilon", style: { lineHeight: "1.5" }, children: Array.isArray(result.keywords) ? result.keywords.join(", ") : result.keywords || noData })
        ] }),
        result.metaRobots && /* @__PURE__ */ jsxRuntime.jsxs(PremiumCard, { background: "neutral0", padding: 5, hasRadius: true, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(MetaLabel, { variant: "pi", fontWeight: "bold", children: formatMessage(t("meta-robots", "Meta Robots")) }),
            /* @__PURE__ */ jsxRuntime.jsx(CopyButton, { onClick: () => handleCopy(result.metaRobots || "", "metaRobots"), children: copyLabel("metaRobots") })
          ] }),
        ...
        result.structuredData && /* @__PURE__ */ jsxRuntime.jsxs(PremiumCard, { background: "neutral0", padding: 5, hasRadius: true, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", marginBottom: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(MetaLabel, { variant: "pi", fontWeight: "bold", children: formatMessage(t("structured-data", "Structured Data (JSON-LD)")) }),
            /* @__PURE__ */ jsxRuntime.jsx(
              CopyButton,
              {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.Box,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx("pre", { style: { margin: 0, fontFamily: "monospace" }, children: JSON.stringify(result.structuredData, null, 2) })
            }
          )
        ] })
      ] })
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Main, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 10, background: "neutral0", minHeight: "100vh", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { maxWidth: "1200px", margin: "0 auto", children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { marginBottom: 10, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "alpha", tag: "h1", fontWeight: "bold", style: { letterSpacing: "-0.5px" }, children: formatMessage(t("title", "SEO Metadata Generator")) }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { marginTop: 3, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "epsilon", textColor: "neutral600", children: formatMessage(t("subtitle", "Paste your content here to generate optimized SEO metadata & JSON-LD.")) }) })
    ] }),
